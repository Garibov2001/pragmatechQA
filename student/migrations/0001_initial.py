# Generated by Django 3.1.3 on 2020-11-22 18:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('picture', models.ImageField(upload_to='static/images/profile_images', verbose_name='Şəkil')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(verbose_name='Məzmun')),
                ('category', models.ManyToManyField(to='student.Category', verbose_name='Kategoriyalar')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student.comment', verbose_name='Komment')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student.question', verbose_name='Sual')),
